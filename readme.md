...
- 2024.7.16 将所有内容都部署到FPGA上，具体步骤清参考[E906仿真步骤与SOC搭建](https://github.com/GuoYS0010/hello_e906_zcu104)与[GROL-OS到FPGA的移植](https://github.com/GuoYS0010/GROL-OS_c906)
...
**（已完成）计划再更改：依旧移植到fpga上，不过直接用阿里的开源C906。**
